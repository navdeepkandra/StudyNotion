...
const Navbar = (props) => {
  ...
  return (
    <div className='w-11/12 max-w-[1160px] py-6 flex items-center justify-between mx-auto'>
      <Link to="/">
      ...
      <div className='flex items-center gap-x-4'>
        ...
        }
        {
            ...
            <Link to="/" onClick={() => {
                ...
                <button className='bg-richblack-800 text-richblack-100 py-[8px] px-[12px] rounded-[8px] border    border-richblack-700'>Log Out</button>
            </Link>
        }
        {
            isLoggedIn &&
